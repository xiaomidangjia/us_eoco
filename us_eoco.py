...
pce_date = ['2023-09-27 20:30:00','2023-09-29 20:30:00','2023-10-27 20:30:00','2023-11-30 21:30:00','2023-12-22 21:30:00']
cpi_date = ['2023-09-27 20:30:00','2023-10-12 20:30:00','2023-11-14 21:30:00','2023-12-12 21:30:00']
feinong_date = ['2023-09-27 20:30:00','2023-10-06 20:30:00','2023-11-03 21:30:00','2023-12-01 21:30:00']
...
for ele in pce_date:
	sub_ele = str(ele)[0:10]
	ele_time = str(ele)[11:19]
	if sub_ele == date_date:
		content = '\n \
%s今晚%s是美国公布PCE时间。\n \
